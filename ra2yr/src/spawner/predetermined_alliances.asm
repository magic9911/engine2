...
%macro House_Make_Ally 3
    ...
    push eax
    mov ecx, edi
    call _HouseClass__Make_Ally ; void HouseClass::Make_Ally(HousesType)
...
%macro  House_Make_Allies_Spawner 3
    SpawnINI__GetInt %1, _str_HouseAllyOne, -1
    cmp al, -1
...
.Dont_Ally_Multi1_%3:
    ...
    SpawnINI__GetInt %1, _str_HouseAllyTwo, -1
    cmp al, -1
...
.Dont_Ally_Multi2_%3:
    ...
    SpawnINI__GetInt %1, _str_HouseAllyThree, -1
    cmp al, -1
...
.Dont_Ally_Multi3_%3:
    ...
    SpawnINI__GetInt %1, _str_HouseAllyFour, -1
    cmp al, -1
...
.Dont_Ally_Multi4_%3:
    ...
    SpawnINI__GetInt %1, _str_HouseAllyFive, -1
    cmp al, -1
...
.Dont_Ally_Multi5_%3:
    ...
    SpawnINI__GetInt %1, _str_HouseAllySix, -1
    cmp al, -1
...
.Dont_Ally_Multi6_%3:
    ...
    SpawnINI__GetInt %1, _str_HouseAllySeven, -1
    cmp al, -1
...
.Dont_Ally_Multi7_%3:
    ...
    SpawnINI__GetInt %1, _str_HouseAllyEight, -1
    cmp al, -1
