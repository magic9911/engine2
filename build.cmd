tools\nasm.exe -f elf -Iinclude/ --prefix _ src\patch.asm -o patch.o
tools\windres.exe --preprocessor=type res\game.rc gameres.o
tools\ld.exe -T game.lds --file-alignment=0x1000 --subsystem=windows --just-symbols=game.sym -o game.exe patch.o gameres.o
